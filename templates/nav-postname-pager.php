		...
		<div class="entry-meta">
			<span class="posted-on">
				<time class="byline--date entry-date published" datetime="<?php echo esc_attr( get_the_date( 'm.d.Y', $prev ) ); ?>">
					<?php echo esc_attr( get_the_date( 'm.d.Y', $prev ) ); ?>
				</time>
			</span>
		</div>
		<h3 class="pager--title h2"><?php echo esc_html( get_the_title( $prev ) ); ?></h3>
		...
		<div class="entry-meta">
			<span class="posted-on">
				<time class="byline--date entry-date published" datetime="<?php echo esc_attr( get_the_date( 'm.d.Y', $next ) ); ?>">
					<?php echo esc_attr( get_the_date( 'm.d.Y', $next ) ); ?>
				</time>
			</span>
		</div>
		<h3 class="pager--title h2"><?php echo esc_html( get_the_title( $next ) ); ?></h3>
